...
export const AdminCoursesPageHeader = () => {
  ...
  return (
    <header className="space-y-4" dir="rtl">
      <nav className="text-sm text-[#64748b]">
        ...
        <span className="font-medium text-[#0f172a]">الدورات</span>
      </nav>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="text-right">
          ...
          <p className="mt-2 text-sm text-[#64748b] sm:text-base">
            إدارة، تدقيق، وإنشاء عروض أكاديمية جديدة.
          </p>
        </div>

        <a
          href="#create-course-form"
          className="inline-flex shrink-0 items-center justify-center gap-2 self-start rounded-2xl bg-[#f5a524] px-5 py-3 text-sm font-bold text-white shadow-[0px_10px_15px_-3px_rgba(245,165,36,0.25)] transition-transform hover:scale-[1.01]"
        >
